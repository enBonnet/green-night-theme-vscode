 ...
 * @prop {Record<'base'|'ansi'|'brightOther'|'other', string[]>} greeny - Greeny color variables.
...
const transformSoft = theme => {
    ...
    const brightColors = [...soft.greeny.ansi, ...soft.greeny.brightOther];
...
module.exports = async () => {
    const yamlFile = await readFile(
        join(__dirname, '..', 'src', 'green-night.yml'),
        'utf-8'
    );
